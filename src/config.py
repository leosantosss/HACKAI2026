...
VIDEO_SOURCE = "assets/test_video.mp4"              # Set to a file path (e.g. "street.mp4") to test on video
#VIDEO_SOURCE = None              # Set to a file path (e.g. "street.mp4") to test on video
# Model Files
SEGFORMER_MODEL = "models/vizzion-navigation-master"
...
# Performance (Mac Pro Mode)
FRAME_SKIP = 1                   # Process every frame on Mac.
DETECTION_SIZE = 512             # Full resolution AI for maximum precision.
...
# Priority order
PRIORITY = ["hazard", "approach", "obstacle"]
